...
@misc{PTC2_microbiome,
  author = {Jade A Derby, Edward W Davis II, Stephanie R Bollman, Michael S Blouin.},
  title = {Snail Hemolymph Microbiome Differs Between Genotypes in a Genomic Region Associated with Resistance to Parasite Infection},
  year = {2025},
  publisher = {GitHub},
  journal = {GitHub repository},
  howpublished = {\url{https://github.com/jaderby2/PTC2-Microbiome}},
  doi = {10.5281/zenodo.YOURDOI}
}
